...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='archivo',
            index=models.Index(fields=['cliente', 'tipo'], name='idx_archivos_cliente_tipo'),
        ),
        migrations.AddIndex(
            model_name='archivo',
            index=models.Index(fields=['sha256'], name='idx_archivos_sha256'),
        ),
        migrations.CreateModel(
